...
![GitHub release (latest by date)](https://img.shields.io/github/downloads/gamekuchen/DoorRestartSystem/v3.5.0/total?style=for-the-badge)
## Info
This is a <SCP SL Exiled 5.0> plugin that allows for the facility to have a "Door Software Restart". 
